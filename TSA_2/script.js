...
function createSlidingBox(selectedDay) {
    ...
    boxElement.style.left = "60%"; 
    boxElement.style.transform = "translateX(-50%)";
    boxElement.style.top = "-300px";
    boxElement.style.width = "200px";
    boxElement.style.height = "200px"; 
    boxElement.style.backgroundColor = "transparent";
    boxElement.style.border = `15px solid ${colors[selectedDay].border}`; 
    ...
    boxElement.style.fontSize = "22px"; 
